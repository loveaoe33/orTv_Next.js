...
import React from "react";
  ...
  return (
    <main><div className="orClient_Container"><div className="orClient_HeadComponent"><h1><Orclient_Head /></h1></div><div className="orClient_MiddleComponent"><h2><Orclient_Middle /></h2></div><div className="orClient_FootComponent"><h3><Orclient_Foot /></h3></div><div>hello2</div></div></main>    
